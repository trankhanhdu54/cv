...
<head>
    ...
    <meta property="og:title" content="CV - Trần Khánh Dư" />
    <meta property="og:description" content="I am a guy who is passionate about IT but currently likes Online Marketing, I think I will combine these 2 things well together." />
    <meta property="og:url" content="https://cv-trandugold.vercel.app" />
    <meta property="og:site_name" content="CV - Trần Khánh Dư" />
    <meta property="og:image" content="public/img/interests/gold.png" />
    <meta property="og:image:secure_url" content="public/img/interests/gold.png" />
    <meta property="og:image:width" content="1024" />
    <meta property="og:image:height" content="683" />
    <meta property="og:image:alt" content="CV - Trần Khánh Dư" />
    <meta property="og:image:type" content="image/jpeg" />

    <title>CV - Trần Khánh Dư </title>
    <link rel="shortcut icon" type="image/x-icon" href="https://trandugold.vercel.app/img/image/image/logo-gold.png">
    ...
    <link rel="stylesheet" href="public/vendor/AlertifyJS/build/css/alertify.css">
    
    <!--  dev icon lib with colored versions -->
    <link rel="stylesheet" href="public/vendor/devicon/devicon.css">
    <link rel="stylesheet" href="public/vendor/devicon/devicon-colors.css">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      ...
      <a class="navbar-brand">
        <span class="d-block d-lg-none">Trần Khánh Dư</span>
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2 img-zoomable" src="public/img/interests/avt.jpg" alt="avatar-cv-trandugold" title="Click to zoom image.">
        </span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#the-end">The End</a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">
            TRẦN KHÁNH
            <span class="text-primary">DƯ</span>
          </h1>
          <div class="subheading mb-0">
            <i class="fa fa-address-card"></i> · Full Stack Web Developer & Trainer
          </div>
          <div class="subheading mb-4">
            <i class="fa fa-map"></i> · Long Phu, long My, Hau Giang · 
            <a href="mailto:trandugold@gmail.com">trandugold@gmail.com</a>
          </div>
          <p class="lead mb-0">Welcome to my CV Online!</p>
          <p class="lead mb-4">
            <em class="subheading-welcome">
              &nbsp;"I will be a painter, I paint your soul with harmless lines of Code."
            </em>
          </p>
          <p class="lead mb-2">
            <strong><i class="devicon-nodejs-plain"></i> Back-End:</strong>
            I am experienced in <strong>Javascript, TypeScript, PHP, SQL ...</strong> 
          </p>
          <p class="lead mb-4">
            <strong><i class="devicon-react-original"></i> Front-End:</strong>
            I am experienced in <strong>HTML, CSS, Javascript, Ajax, Bootstrap ...</strong>
          </p>
          <p class="lead mb-2">
            I am a guy who is passionate about IT but currently likes Online Marketing, I think I will combine these 2 things well together.
          </p>
          <p class="lead mb-5">
            My Profile: 
            <a class="text-bold-500" target="blank" href="https://trandugold.vercel.app/">
              <strong>https://trandugold.vercel.app</strong>
            </a>
          </p>
          <div class="social-icons">
            <a target="blank" href="https://www.tiktok.com/@trandugold">
              <i class="fab fa-tiktok"></i>
            </a>
            <a target="blank" href="https://instagram.com/trandugold/">
              <i class="fab fa-instagram-square"></i>
            </a>
            <a target="blank" href="https://www.facebook.com/trandugold">
              <i class="fab fa-facebook"></i>
            </a>
            <a target="blank" href="https://www.youtube.com/@trandugold">
        ...
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-4">
            <div class="resume-content mr-auto">
              ...
              <div class="mb-0">
                <i class="fa-custom-list fa fa-bookmark text-warning"></i>&nbsp;
                Get website design on demand with reasonable prices depending on each customer's case according to each requirement..<br>
              </div>
            </div>
          </div>
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-4">
            <div class="resume-content mr-auto">
              ...
              <div class="mb-0">
                <i class="fa-custom-list fa fa-bookmark text-warning"></i>&nbsp;
                Get Facebook ads, Google ads, Tiktok ads digital marketing aimed at target customers.
              </div>
            </div>
          </div>
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-4">
            <div class="resume-content mr-auto">
              ...
              <div class="mb-0">
                <i class="fa-custom-list fa fa-bookmark text-warning"></i>&nbsp;
                A web application is a website that is also an application. Web applications run in any operating system, every platform.
              </div>
            </div>
          </div>
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-4">
            <div class="resume-content mr-auto">
              ...
              <div class="mb-0">
                <i class="fa-custom-list fa fa-bookmark text-warning"></i>&nbsp;
                From visual design, graphics. To website design and website development. Content and ads Facebook, Google, Tiktok.
              </div>
            </div>
          </div>
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-4">
            <div class="resume-content mr-auto">
              ...
              <div class="mb-0">
                <i class="fa-custom-list fa fa-bookmark text-warning"></i>&nbsp;
                UI/UX design, graphic design, banners, logos... Design demo templates, mockups, product advertising images.
              </div>
            </div>
          </div>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">
                <a href="https://ctec.edu.vn/" target="blank">
              ...
              <div class="mb-0">
                <i class="fa-custom-list fa fa-bookmark text-warning"></i>&nbsp;
                Specialty: IT Communication, Graphic Design, Website Design.
              </div>
              <!-- <p>GPA: 3.37</p> -->
            </div>
            <div class="resume-date text-md-right">
              <span class="text-primary">09/2018 - 07/2021</span>
            </div>
          </div>
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">
                <a href="https://www.ctu.edu.vn/" target="blank">
                  SPECIALTY : INFORMATION TECHNOLOGY
                </a>
              </h3>
              <div class="subheading mb-3">
            ...
            <div class="resume-date text-md-right">
              <span class="text-primary">08/2021 - 10/2023</span>
            </div>
          </div>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
        <div class="my-auto">
          ...
          <ul class="list-inline dev-icons">
            ...
            <li class="list-inline-item">
              <i class="devicon-jquery-plain-wordmark colored" title="Jquery"></i>
            </li>
            ...
            <li class="list-inline-item">
              <i class="devicon-wordpress-plain-wordmark colored" title="Wordpress"></i>
            </li>
            
          </ul>


          <div class="subheading mb-3">Steps to build an Online Marketing strategy</div>
          <ul class="fa-ul mb-0">
            <li>
            ...
            <li>
              <i class="fa-li fa fa-check"></i>
              Define goals for your online marketing strategy
            </li>
            <li>
              <i class="fa-li fa fa-check"></i>
            ...
            <li>
              <i class="fa-li fa fa-check"></i>
              Selection of communication channels: Facebook Fanpage, YouTuber, Tiktoker
            </li>
            <li>
              <i class="fa-li fa fa-check"></i>
              <i>Track the effectiveness of your marketing strategy</i>
            </li>
          </ul>

          <!-- <hr class="m-0"> --> <div class="subheading mb-3"></div>
          ...
          <ul class="fa-ul mb-0">
            ...
            <li>
              <i class="fa-li fa fa-check"></i>
              Marketing Online & ADS facebook, Google, Tiktok, Instagram
            </li>
            <li>
              ...
            </li>
            <li>
              <i class="fa-li fa fa-check"></i>
              <i>Research, learn new things and make continuous progress!</i>
            </li>
          </ul>
        </div>
      </section>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="experience">
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              ...
              <div class="mb-0">
                <ul class="fa-ul mb-0">
                  <li>
                    <i class="fa-li fa fa-check"></i>
                    Write articles to advertise products through facebook, zalo, ...
                  </li>
                  <li>
                    <i class="fa-li fa fa-check"></i>
                    Staging and editing videos uploaded to Facebook, Zalo, Tiktok, ...
                  </li>
                  <li>
                    <i class="fa-li fa fa-check"></i>
                    Introduction, product consulting, answering customer inquiries via phone and email.
                  </li>
                  <li>
                    <i class="fa-li fa fa-check"></i>
                    Project a Sale promotion, Write product articles.
                  </li>
                  <li>
                    <i class="fa-li fa fa-check"></i>
                    Finding the right customer file increases revenue.
                  </li>
                  <li>
                    <i class="fa-li fa fa-check"></i>
                    ADS ads facebook, tiktok, Instagram.
                  </li>
                </ul>
              </div>
              <!-- <p>GPA: 3.37</p> -->
            ...
            <div class="resume-date text-md-right">
              <span class="text-primary">05/2022 - 04/2023</span>
            </div>
          </div>
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">
                <a class="text-primary" target="blank">
                  MARKETING STAFF & CONSULTANTS
                </a>
              </h3>
              <div class="subheading mb-3">
                DANG KHOA WEDDING SERVICE COMPANY
              </div>
              <div class="mb-0">
                <ul class="fa-ul mb-0">
                  <li>
            ...
            <div class="resume-date text-md-right">
              <span class="text-primary">05/2023 - Present time</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
        <div class="my-auto">
          ...
          <p class="mb-2">In addition to being a coder artist, I also spend a little time learning new things, I think I will grow without stopping and 100 years of life for me is too short!</p>
          <p class="mb-2">Also, I love watching Anime, Chinese 3D animation and some sci-fi and fantasy genre movies.</p>
          <p class="mb-3">Last but not least, I enjoyed reading the mystical stories of Chinese authors. Let's take a look at some of my favorite series:</p>
          <div class="interest-pictures">
            <img class="img-zoomable" src="public/img/interests/dptk.jpg" alt="cv-trandugold" title="Click to zoom image.">
            <img class="img-zoomable" src="public/img/interests/dldl.jpg" alt="cv-trandugold" title="Click to zoom image.">
            <img class="img-zoomable" src="public/img/interests/giathien.jpg" alt="cv-trandugold" title="Click to zoom image.">
            <img class="img-zoomable" src="public/img/interests/vdck.jpg" alt="cv-trandugold" title="Click to zoom image.">
            
          </div>
        </div>
      </section>

      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="the-end">
        <div class="my-auto">
          <h2 class="mb-5">The End</h2>
          <p>Finally, I would like to say <strong>"Thank You"</strong> for spent time to look at my CV profile.</p>
          <p><em>You're a flower on earth, let's make your life beautiful and meaningful (◕‿↼)</em></p>

          <div class="cat-typing">
    ...
    <!-- Show modal zoom image when click - https://trungquandev.com -->
    <div id="div-zoom-area" class="modal">
      <img id="img-zoom-area-content">
      <!-- <div id="caption">Do not use.</div> -->
    </div>
    ...
    <script src="public/vendor/AlertifyJS/build/alertify.js"></script>

    <!-- Custom scripts for this template -->
    <script src="public/js/resume.js"></script>

  </body>
    <!-- website được lấy từ trungquandev -->
